...
export const Route = createFileRoute("/_authenticated/donnees/fournisseurs")({
  component: () => (
    <CrudTable
      title="Fournisseurs"
      table="fournisseurs"
      searchFields={["raison_sociale", "code", "ville"]}
      fields={[
        ...
        { name: "delai_paiement", label: "Délai paiement (j)", type: "number" },
